...
This vignette demonstrates how to use the *auditor* package for auditing model residuals. 
...
In this vignette we will use first pipeline. However alternative evaluations will be showed as comments.
...
Without specified variable observations are in the order fro the data set. 
...
Other methods and plots are described in other vignettes. See: [The half-normal plots](https://mi2-warsaw.github.io/auditor/articles/HalfNormal.html)
