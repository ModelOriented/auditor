...
```{r results = 'hide'}
exp_glm <- DALEX::explain(model_glm, data = titanic_imputed, y = titanic_imputed$survived)
exp_rf <- DALEX::explain(model_rf, data = titanic_imputed, y = titanic_imputed$survived)
```
