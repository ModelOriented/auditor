...
Function `plot_prediction` presents observed values on the x-axis. However, on the x-axis there may be values of any model variable or by index of observations (`variable = NULL`). 
