...
| Half-Normal                                           | `plotHalfNormal()` </br> `plot(..., type = "HalfNormal")`              |    yes     |     yes        | [Examples](https://mi2-warsaw.github.io/auditor/articles/HalfNormal.html) |
...
| Plot Residuals vs Observed, Fitted or Variable Values | `plotResidual()` </br> `plot(..., type = "Residual")`                  |            |                | [Examples](https://mi2-warsaw.github.io/auditor/articles/model_performance_audit.html#plotresidual---plot-residuals-vs-observed-fitted-or-variable-values)                                                                                  |
| Residual Boxplot                                      | `plotResidualBoxplot()` </br> `plot(..., type = "ResidualBoxplot")`    |            |                | [Examples](https://mi2-warsaw.github.io/auditor/articles/model_performance_audit.html#plotresidualboxplot---boxplot-of-residuals)   |
| Residual Density                                      | `plotResidualDensity()` </br> `plot(..., type = "ResidualDensity")`    |            |                | [Examples](https://mi2-warsaw.github.io/auditor/articles/model_performance_audit.html#plotresidualdensity---density-of-residuals)  |
