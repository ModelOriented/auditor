...
function autocorrelation(data){
  var pointData = data[0], smoothData = data[1], scoreData = data[2];
  for (var i=0; i<n; i++){
    var modelName = modelNames[i];
    singlePlot(modelName, pointData, smoothData, scoreData[modelName], i+1);
  }
}

function singlePlot(modelName, pointData, smoothData, scoreText, i) {
      ...
      svg.append("text")
 	  ...
 	  if (score === true) {
 	    svg.append("text")
          ...
          .text("Durbin-Watson Score: " + scoreText[0]);
