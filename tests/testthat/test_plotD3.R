...
#   expect_is(plotD3_residual(mr_glm, smooth = TRUE, point_count = 5), "r2d3")
...
#   expect_is(plotD3_prediction(mr_glm, smooth = TRUE, point_count = 5), "r2d3")
#   expect_is(plotD3_prediction(mr_glm), "r2d3")
