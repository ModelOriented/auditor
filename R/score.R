...
#' 'one_minus_auc', 'one_minus_acc', 'one_minus_F1', 'one_minus_precission', 'one_minus_recall', 'one_minus_specificity', 'acc', 'F1', 'precission', 'recall', 'specificity'
...
#' \code{\link{score_one_minus_F1}}, \code{\link{score_one_minus_precission}},
#' \code{\link{score_one_minus_recall}}, \code{\link{score_one_minus_specificity}}, \code{\link{score_acc}}, \code{\link{score_F1}}, \code{\link{score_precission}},
...
score <- function(object, score = 'mse', ...){
  ...
  switch(score,
         ...
         one_minus_precission = { return(score_one_minus_precission(object, ...)) },
         ...
         precission = { return(score_precission(object, ...)) },
         recall = { return(score_recall(object, ...)) },
         specificity = { return(score_specificity(object, ...)) }

  )
  stop( "Wrong type of score. Possible values: 'auc', 'cooksdistance', 'dw', 'peak', 'halfnormal', 'rmse', 'mae', 'mse', 'rec', 'rroc', 'runs', 'one_minus_auc', 'one_minus_acc', 'one_minus_F1', 'one_minus_precission', 'one_minus_recall', 'one_minus_specificity', 'acc', 'F1', 'precission', 'recall', 'specificity'." )
}
