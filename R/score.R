...
#'
#' @seealso \code{\link{score_cooksdistance}, \link{score_dw}, \link{score_peak}, \link{score_halfnormal}, \link{score_mae}, \link{score_mse}, \link{score_rec}, \link{score_auc}, \link{score_rroc}, \link{score_runs}}
#'
