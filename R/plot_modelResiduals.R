...
#'
#' @param x object of class modelResiduals
#' @param ... other arguments dependent on the type of plot or additionl objects of class modelResiduals
...
#'
#' @method plot modelResiduals
#'
#' @export

plot.modelResiduals <- function(x, ..., type="Residual", ask = TRUE){
